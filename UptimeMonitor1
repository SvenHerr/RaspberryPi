...
try:
 webservice.send('token','Magic Mirror','','1',value['CPU_USAGE'],value['MEM_TOTAL'],value['MEM_USAGE'],value['MEM_FREE'],value['STORAGE_TOTAL'],value['STORAGE_USAGE'],value['STORAGE_FREE'],value['RUNNING_TIME'],value['TEMPERATURE'])
 print(r)
except:
  print("Error")
